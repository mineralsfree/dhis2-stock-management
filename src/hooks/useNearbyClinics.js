...
const dataQuery = {
  ...
  orgUnit: {
    ...
    params: {
      fields: [
        'name,id,dataSets[name,id],children[name,id,dataSets[name,id]]'
      ]
    }
  }
}
...
const mergeData = (data) => {
  ...
  data.commoditiesSet.dataSetElements.forEach(d => {
    ...
    let endBalances = data.commoditiesValue.dataValues.filter(dataValues => dataValues.dataElement === d.dataElement.id && dataValues.categoryOptionCombo === END_BALANCE_ID);
